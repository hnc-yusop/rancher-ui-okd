  ...
  actions: {
    ...
    logout(transition, errorMsg) {
      ...
      access.clearToken().finally(() => {
        ...
        window.location.href='https://a0f02aac188b34888bc2fe673f4528b2-479762734.ap-northeast-2.elb.amazonaws.com/auth/realms/my_realm/protocol/openid-connect/logout?redirect_uri='+url;
      });
    },
